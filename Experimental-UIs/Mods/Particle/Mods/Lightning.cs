...
public class Lightning : Effect
{
    ...
    public override void Update()
    {
        ...
        Vector3 start = new Vector3(
            StrikePosition.x + UnityEngine.Random.Range(-25f, 25f),
            StrikePosition.y + UnityEngine.Random.Range(10f, 20f),
            StrikePosition.z + UnityEngine.Random.Range(-25f, 25f));

        Vector3 end = new Vector3(
            StrikePosition.x + UnityEngine.Random.Range(-10f, 10f),
            StrikePosition.y - UnityEngine.Random.Range(10f, 20f),
            StrikePosition.z + UnityEngine.Random.Range(-10f, 10f));
