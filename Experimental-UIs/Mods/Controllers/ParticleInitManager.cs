...
namespace Experimental.Mods.Controllers
{
    public class ParticleInitManager : MonoBehaviour
    {
        ...
        private void InitializeParticles()
        {
            ...
            // cast magic 
            ParticleManager.Register("Fireball", new Fireball("Fireball", GTPlayer.Instance.RightHand.controllerTransform.position, GTPlayer.Instance.RightHand.controllerTransform.forward, 20f));
